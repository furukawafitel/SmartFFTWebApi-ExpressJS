...
class Sct_SctProcessingCostByMfgTotal_Bom_FlowSQL {
  static GetBySctId = async (dataItem) => {
    let sql = `  
            ...
            FROM 
                SCT tb_1 
                    INNER JOIN 
                SCT_PROCESSING_COST_BY_MFG_TOTAL tb_2
...
module.exports = Sct_SctProcessingCostByMfgTotal_Bom_FlowSQL;
