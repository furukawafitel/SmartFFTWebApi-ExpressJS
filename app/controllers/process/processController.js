const ProcessModels = require("../../models/process/processModel");
...
const getProcess = async (req, res) => {
  try {
    ...
    if (dataItem !== "") {
      ProcessModels.getProcess(dataItem, (err, data) => {
...
const searchProcess = async (req, res) => {
  try {
    ...
    if (dataItem !== "") {
      ProcessModels.searchProcess(dataItem, (err, data) => {
...
const createProcess = async (req, res) => {
  try {
    ...
    if (dataItem !== "") {
      ProcessModels.createProcess(dataItem, (err, data) => {
        res.send({
          Status: true,
...
const updateProcess = async (req, res) => {
  try {
    ...
    if (dataItem !== "") {
      ProcessModels.updateProcess(dataItem, (err, data) => {
        res.send({
          Status: true,
...
const deleteProcess = async (req, res) => {
  try {
    ...
    if (dataItem !== "") {
      ProcessModels.deleteProcess(dataItem, (err, data) => {
        res.send({
          Status: true,
...
const GetByLikeProcessName = async (req, res) => {
  try {
    let dataItem;
    if (Object.entries(req.body).length === 0) {
      dataItem = JSON.parse(req.query.data);
    ...
    if (dataItem !== "") {
      ProcessModels.GetByLikeProcessName(dataItem, (err, data) => {
        res.send({
          Status: true,
          Message: "Search Data Success",
          ResultOnDb: data,
...
const GetByLikeProcessNameAndProductMainIdAndInuse = async (req, res) => {
  try {
    let dataItem;
    if (Object.entries(req.body).length === 0) {
      dataItem = JSON.parse(req.query.data);
    ...
    if (dataItem !== "") {
      ProcessModels.GetByLikeProcessNameAndProductMainIdAndInuse(
        dataItem,
        (err, data) => {
          res.send({
            Status: true,
